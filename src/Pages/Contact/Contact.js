             ...
             <div class="flex-1 lg:flex lg:items-center lg:-mx-6">
               <div class="text-white lg:w-1/2 lg:mx-6">
                 ...
                 <div class="mt-6 md:mt-8">
                   <h3 class="text-gray-300 ">Contact Me</h3>
                   <div class="mt-6 space-y-8 md:mt-8">
                     <p class="flex items-start -mx-2 text-white">
                       <svg
                         xmlns="http://www.w3.org/2000/svg"
                         class="text-white w-6 h-6 mx-2"
                         fill="none"
                         viewBox="0 0 24 24"
                         stroke="currentColor"
                         stroke-width="2"
                       ...
                       <span class="mx-2truncate w-72 dark:text-gray-400 text-white">
                         Dhaka, Bangladesh
                       </span>
                     </p>
                     ...
                     <p class="flex items-start -mx-2">
                       ...
                       <span class="mx-2 text-white">(+880) 1518390570 </span>
                     </p>
                   ...
                   <div class="flex mt-4 -mx-1.5 ">
                     <a
                       ...
                       href="https://www.linkedin.com/in/salma-akter-63976624a/"
                     >
                       <svg
                         class="w-8 h-8"
                         viewBox="0 0 24 24"
                     ...
                     <a
                       class="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500"
                       href="https://www.facebook.com/suhana.salma.96/"
                     >
                       <svg
                         class="w-8 h-8"
                         viewBox="0 0 24 24"
                     ...
                     <a
                       class="mx-1.5 text-white transition-colors duration-300 transform hover:text-blue-500"
                       href="https://www.instagram.com/suhana.salma.96/"
                     >
                       <svg
                         class="w-8 h-8"
                         viewBox="0 0 24 24"
               ...
               <div class="mt-8 lg:w-1/2 lg:mx-6">
                 <div class="w-full px-8 py-10 mx-auto overflow-hidden bg-white shadow-2xl rounded-xl lg:max-w-xl">
                   ...
                   <form ref={form} class="mt-6 " onSubmit={handleEmail}>
                     <div class="flex-1">
